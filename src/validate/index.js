...
export default async () => {
  const validate = validateFactory([
    ...
    await FieldExclusion([
      ...
      {tag: /^(506|540)$/u, subfields: [{code: /^a$/u, value: /^(Käyttöoikeus Helmet-kirjastokortilla\.|Helmet bibliotekskort krävs\.)$/ui}]}, // eslint-disable-line prefer-named-capture-group
